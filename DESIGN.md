...
components:
  ...
  results-view:
    ...
    paddingTopDesktop: 48px
    paddingBottom: 64px
    primaryAction: "Use one primary action for the whole batch; individual file downloads are secondary when multiple outputs exist."
  category-tab:
    backgroundColor: transparent
    textColor: "{colors.muted}"
    typography: "{typography.nav-link}"
